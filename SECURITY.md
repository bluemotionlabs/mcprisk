...
This is a small, early-stage project, so there's no formal SLA yet. We'll acknowledge reports and work with you on a reasonable timeline before anything is disclosed publicly.
...
This is a continuously deployed service, not a versioned library with multiple maintained branches. Only the latest version is supported.
